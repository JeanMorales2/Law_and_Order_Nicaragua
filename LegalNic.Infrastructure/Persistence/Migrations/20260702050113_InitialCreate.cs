        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Availability_LawyerProfiles_LawyerProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_LawyerProfiles_LawyerProfileId",
                        column: x => x.LawyerProfileId,
                        principalTable: "LawyerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VerificationDocuments_LawyerProfiles_LawyerProfileId",
                        column: x => x.LawyerProfileId,
                        principalTable: "LawyerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VerificationDocuments_Users_ReviewedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    CaseDetail = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availability_LawyerProfileId_DayOfWeek_StartTime_EndTime",
                table: "Availability",
                columns: new[] { "LawyerProfileId", "DayOfWeek", "StartTime", "EndTime" });

            migrationBuilder.CreateIndex(
                name: "IX_LawyerProfiles_BarNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_ServiceRequestId_SentAt",
                table: "Messages",
                columns: new[] { "ServiceRequestId", "SentAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_ClientId_Status",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_LawyerProfileId_CategoryId_Name",
                table: "Services",
                columns: new[] { "LawyerProfileId", "CategoryId", "Name" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VerificationDocuments_LawyerProfileId_DocumentType_IsDeleted",
                table: "VerificationDocuments",
                columns: new[] { "LawyerProfileId", "DocumentType", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_VerificationDocuments_ReviewedByAdminId",
                table: "VerificationDocuments",
